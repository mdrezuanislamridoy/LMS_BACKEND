...
export declare const getSingleEnrollment: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const updateEnrollmentStatus: (req: Request, res: Response, next: NextFunction) => Promise<void>;
export declare const updateVideoProgress: (req: Request, res: Response, next: NextFunction) => Promise<void>;
